...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/morning-grass-df81
```

A live public deployment of this template is available at [https://morning-grass-df81.templates.workers.dev](https://morning-grass-df81.templates.workers.dev)
